...
function loadGame(loadgame) {
    ...
    if (game.upgradesBought[11] == true) {
        document.getElementsByClassName("upgradeButton")[11].style.display = "none"
        document.getElementsByClassName("upgradeButton")[12].style.display = "inline-block"
        document.getElementsByClassName("upgradeButton")[13].style.display = "inline-block"
        document.getElementsByClassName("upgradeButton")[14].style.display = "inline-block"
        document.getElementsByClassName("upgradeButton")[15].style.display = "inline-block"
        ...
        for (i = 0; i < 4; i++) document.getElementsByClassName("waterButton")[i].style.display = "inline-block"
...
function buyUpgrade(x) {
    ...
    else if (x == 12 && game.water.gte(1) && game.upgradesBought[12] != true) {
        document.getElementsByClassName("upgradeButton")[12].style.display = "none"
